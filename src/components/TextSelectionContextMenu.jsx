      ...
      {!showCommentForm ? (
        <div className="py-2">
          <button
            ...
            className="w-full px-4 py-2 text-left text-gray-700 bg-white flex items-center gap-2"
          >
        ...
        <div className="p-4">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-sm font-medium bg-white text-gray-900">Add Comment</h3>
            <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {success && (
              <div className="text-sm text-green-600">Comment submitted successfully!</div>
            )}
            <button
              type="submit"
