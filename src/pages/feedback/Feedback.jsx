          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="playbook-app-overview">Playbook App Overview</option>
                <option value="ccc-initiative">CCC Initiative Overview</option>
                <option value="communications">Communication Plan</option>
                ...
                <option value="projects-archetypes">Projects Archetypes</option>
