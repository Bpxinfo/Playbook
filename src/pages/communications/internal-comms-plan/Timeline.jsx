  ...
  return (
    <div className="p-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-light text-white mb-6 text-center bg-red-800 p-4 uppercase">Communication Timeline</h1>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="text-lg font-semibold text-red-800 mb-2">Phase 1: Planning</h3>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="text-lg font-semibold text-red-800 mb-2">Phase 2: Launch</h3>
                  <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              <p className="text-gray-700">
                Essential activities that must be completed on schedule:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
