            ...
            <div className="space-y-4">
              <div className="bg-emerald-50 border-l-4 border-emerald-400 p-4 rounded-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h2 className="text-lg font-semibold text-gray-800 mb-2">Development Streams</h2>
                    <p className="text-gray-700 mb-4 dark:text-black">Work Development meetings will have their own communication streams:</p>
