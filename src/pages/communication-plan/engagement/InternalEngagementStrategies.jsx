...
const InternalEngagementStrategies = () => {
  return (
    <div className="p-8 mx-auto max-w-7xl">
      <h1 className="text-4xl font-light text-white mb-8 text-center bg-red-800 p-4 uppercase">Internal Engagement Strategies</h1>
      ...
      <div className="space-y-8">
        ...
        <section className="bg-white rounded-lg shadow-md p-6">
          ...
          <ul className="list-disc pl-6 space-y-3 text-gray-700">
            ...
            <li>Function Z à Goal (To be defined between CCC Leadership SteerCo & Function Leads)</li>
          </ul>
        </section>
        ...
        <section className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-gray-700 mt-4">Key Platforms:</p>
          <ul className="list-disc pl-6 space-y-3 text-gray-700">
