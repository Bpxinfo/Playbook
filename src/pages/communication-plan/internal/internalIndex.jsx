...
export default function CommInternalHome() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-12">
        <h1 className="text-4xl font-light text-red-800 mb-6">Internal Communications</h1>
        
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <p className="text-gray-700 mb-4">
          Strategies and frameworks for internal stakeholder communication</p>
