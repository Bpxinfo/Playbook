      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="space-y-8">
          <section className="bg-white shadow-md rounded-lg p-6 text-left">
            <h2 className="text-2xl text-red-800 mb-4">CCC Meeting Intro</h2>
          ...
          <section className="bg-white shadow-md rounded-lg p-6 text-left">
            <h2 className="text-2xl text-red-800 mb-4">Initiative Deep Dive</h2>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section className="bg-white shadow-md rounded-lg p-6 text-left">
            <h2 className="text-2xl text-red-800 mb-4">Administrative Tasks</h2>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
