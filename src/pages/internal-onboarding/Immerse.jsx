      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="space-y-8">
          <section className="bg-white shadow-md rounded-lg p-6 text-left">
            <h2 className="text-2xl text-red-800 mb-4">Shadowing and Learning</h2>
          ...
          <section className="bg-white shadow-md rounded-lg p-6 text-left">
            <h2 className="text-2xl text-red-800 mb-4">Hands-on Integration</h2>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section className="bg-white shadow-md rounded-lg p-6 text-left">
            <h2 className="text-2xl text-red-800 mb-4">Relationship Building</h2>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <section className="bg-white shadow-md rounded-lg p-6 text-left">
            <h2 className="text-2xl text-red-800 mb-4">Project Updates</h2>
