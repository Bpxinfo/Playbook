          ...
          <section className="bg-white rounded-lg shadow-md p-6">
            <div className="relative mb-6">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-full border bg-white text-black border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent"
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              {filteredTerms.length === 0 && (
                <p className="text-gray-500 text-center py-4">No terms found matching your search.</p>
              )}
            </div>
          </section>
        </div>
