          ...
          <section className="bg-white rounded-lg shadow-md p-6">
            <div className="relative mb-6">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-full border bg-white border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent"
              />
            </div>
