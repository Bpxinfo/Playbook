      ...
      <div className="mb-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <p className="text-gray-700 mb-4">
            The Playbook App Overview section provides a comprehensive introduction to the CCC Playbook application. Here you'll find information about why this playbook exists, what it aims to achieve, and how it serves as a crucial resource for the Community Cancer Collective (CCC) initiative.
          </p>
