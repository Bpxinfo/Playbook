...
- Documentation of business justification and approvals`}];return e.jsx("div",{className:"p-8 max-w-7xl mx-auto",children:e.jsxs("div",{className:"mb-12",children:[e.jsx("h1",{className:"text-4xl font-light text-white mb-8 text-center bg-red-800 p-4 uppercase",children:"CCC Initiative FAQs"}),e.jsx("div",{className:"space-y-8",children:t.map((i,n)=>e.jsxs("div",{className:"bg-white rounded-lg shadow-lg p-6",children:[e.jsx("h2",{className:"text-xl font-semibold text-red-800 mb-4",children:i.question}),i.answer.split("\\n").map((a,s)=>e.jsx("p",{className:"text-gray-700 mb-2",children:a},s))]},n))})]})})}export{c as default};
