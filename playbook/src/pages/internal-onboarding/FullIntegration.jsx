  ...
  return (
    <div className="p-8 flex justify-center">
      <div className="max-w-4xl w-full">
        <h1 className="text-4xl font-light text-red-800 mb-8 text-center">Full Integration (5-6 months)</h1>
        <div className="space-y-8">
          <section className="bg-white shadow-md rounded-lg p-6 text-left">
            <h2 className="text-2xl text-red-800 mb-4">A. Comprehensive Review</h2>
          ...
          <section className="bg-white shadow-md rounded-lg p-6 text-left">
            <h2 className="text-2xl text-red-800 mb-4">B. Forward Planning</h2>
            <ol className="list-decimal pl-6 space-y-2 text-gray-700">
          ...
          <section className="bg-white shadow-md rounded-lg p-6 text-left">
            <h2 className="text-2xl text-red-800 mb-4">C. Feedback and Refinement</h2>
            <ol className="list-decimal pl-6 space-y-2 text-gray-700">
          ...
          <section className="bg-white shadow-md rounded-lg p-6 text-left">
            <h2 className="text-2xl text-red-800 mb-4">D. Leadership and External Engagement</h2>
            <ol className="list-decimal pl-6 space-y-2 text-gray-700">
