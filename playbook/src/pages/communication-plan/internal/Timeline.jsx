    ...
    <div className="p-8">
      ...
      <div className="max-w-4xl">
        <section className="mb-8">
          <h2 className="text-2xl text-red-800 mb-4">Quarter 1</h2>
          <ul className="list-disc pl-6 space-y-3 text-gray-700">
            ...
            <li>Develop RACI / DAI chart and establish KPIs</li>
            <li>Create secure data-sharing protocol for partners, community sites</li>
          </ul>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl text-red-800 mb-4">Quarter 2</h2>
          <ul className="list-disc pl-6 space-y-3 text-gray-700">
        ...
        <section className="mb-8">
          <h2 className="text-2xl text-red-800 mb-4">Quarter 3</h2>
          <ul className="list-disc pl-6 space-y-3 text-gray-700">
