...
const CommunicationChannels = () => {
  return (
    <div className="p-8">
      <h1 className="text-4xl font-light text-red-800 mb-8">Communication Channels</h1>

      <div className="max-w-6xl">
        <h2 className="text-2xl text-red-800 mb-4">Table 2 – CCC Communication Channels</h2>
